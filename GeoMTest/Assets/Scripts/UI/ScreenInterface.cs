        ...
        public void Execute(ScreenTypes screenType)
        {
            ...
            switch (screenType)
            {
                ...
                case ScreenTypes.MainMenu:
                    ...
                    break;
                case ScreenTypes.BoostsMenu:
                    _currentWindow = _screenFactory.GetBoostsMenu();
                    break;
                default:
                    break;
            }
        ...
        public void AddObserver(ScreenTypes screenType, IListenerScreen listenerScreen)
        {
            switch (screenType)
            {
                ...
                case ScreenTypes.MainMenu:
                    ...
                    break;
                case ScreenTypes.BoostsMenu:
                    _screenFactory.GetBoostsMenu().ShowUI += listenerScreen.ShowScreen;
                    _screenFactory.GetBoostsMenu().HideUI += listenerScreen.HideScreen;
                    _screenFactory.GetBoostsMenu().Hide();
                    break;
                default:
                    break;
            }
